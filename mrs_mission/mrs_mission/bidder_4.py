...
class Bidder4(Node):        # Bidder node for robot 4
    def __init__(self):
        super().__init__('bidder4_node')
        ...
        self.robot_id = 4   # hardcoded for all bidders
        ...
        self.task_level = defaultdict(int) # task_id -> max tasklevel seen (0/1/2) 
...
def main(args=None):
    ...
    bidder4_node = Bidder4()
    try:
        rclpy.spin(bidder4_node)
    except KeyboardInterrupt:
        pass
    finally:
        bidder4_node.destroy_node()
        rclpy.shutdown()
